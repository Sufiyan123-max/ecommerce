            ...
            <div className='max-w-6xl mx-auto flex justify-between items-center'>
                ...
                <nav className='flex gap-7 items-center'>
                    ...
                    <div className='hidden md:block'>
                        {!isAuthenticated ? (
                            <Link to={'/signin'} className='bg-red-500 text-white px-3 py-1 rounded-md cursor-pointer'>Sign In</Link>
                        ) : (
                            <button onClick={signOut} className='bg-gray-100 px-3 py-1 rounded-md'>Sign Out</button>
                        )}
                    </div>
                    {
